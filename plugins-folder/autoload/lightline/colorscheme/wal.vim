...
" [wal.vim](https://github.com/joshdick/wal.vim/)

" This is a [lightline.vim](https://github.com/itchyny/lightline.vim) colorscheme for use with
" the [wal.vim](https://github.com/joshdick/wal.vim) colorscheme.

let s:colors = wal#GetColors()

if get(g:, 'wal_termcolors', 256) == 16
